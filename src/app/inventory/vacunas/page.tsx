...
export default function VacunasPage() {
    ...
    const handleAddSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const newItem: InventoryItem = { id, name, category: 'vacuna', stock };
    ...
    return (
        <AppLayout>
            <div className="flex flex-col gap-6">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Stock de Vacunas</CardTitle>
                        <CardDescription>Lista de productos biológicos disponibles.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Table>
                            <TableHeader>
                 ...
                 <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>Añadir Nueva Vacuna</DialogTitle>
                        ...
                        <form onSubmit={handleAddSubmit} id="add-item-form" className="space-y-4 py-4">
                             <div className="space-y-2">
                                ...
                                <Input id="id" name="id" type="text" placeholder="Ej: VAC-04" required />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="name">Nombre del Producto</Label>
                                <Input id="name" name="name" type="text" placeholder="Ej: Vacuna Influenza Porcina" required />
                            </div>
                             <div className="space-y-2">
                                <Label htmlFor="stock">Stock Inicial (dosis/ml)</Label>
