...
export default function PerdidaReproductivaForm() {
    const handleExportPDF = () => {
        const doc = new jsPDF();
        doc.setFontSize(22);
        doc.text("Registro de Pérdida Reproductiva", 14, 22);

        autoTable(doc, {
            startY: 30,
            head: [['ID Madre', 'Fecha', 'Tipo de Pérdida', 'Causa / Observación']],
        ...
        <main id="printable-content" className="max-w-4xl mx-auto bg-white p-8 sm:p-12 shadow-lg">
            <div className="flex items-center justify-between mb-8">
                ...
                <div className="text-right">
                    <h2 className="text-2xl font-bold uppercase">Pérdida Reproductiva</h2>
                </div>
            </div>
